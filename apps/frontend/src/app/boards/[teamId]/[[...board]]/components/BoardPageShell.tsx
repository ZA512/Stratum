                      ...
                      <div className="flex flex-wrap items-center gap-2 text-xs">
                        {(() => {
                          const tooltip = pickTooltipVariant(helpMode, {
                            ...
                            info: {
                              title: tBoard('help.quickFilters.mine.title'),
                              description: tBoard('help.quickFilters.mine.info'),
                            },
                          });
                          const button = (
                            <button
                        ...
                        {(() => {
                          const tooltip = pickTooltipVariant(helpMode, {
                            ...
                            info: {
                              title: tBoard('help.quickFilters.priority.title'),
                              description: tBoard('help.quickFilters.priority.info'),
                            },
                          });
                          const button = (
                            <button
                        ...
                        {(() => {
                          const tooltip = pickTooltipVariant(helpMode, {
                            ...
                            info: {
                              title: tBoard('help.quickFilters.dueDate.title'),
                              description: tBoard('help.quickFilters.dueDate.info'),
                            },
                          });
                          const button = (
                            <button
                        ...
                        {(() => {
                          const tooltip = pickTooltipVariant(helpMode, {
                            ...
                            info: {
                              title: tBoard('help.quickFilters.expert.title'),
                              description: tBoard('help.quickFilters.expert.info'),
                            },
                          });
                          const button = (
                            <button
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {(() => {
                          const tooltip = pickTooltipVariant(helpMode, {
                            ...
                            info: {
                              title: tBoard('help.filtersButton.title'),
                              description: tBoard('help.filtersButton.info'),
                            },
                          });
                          const button = (
                            <button
