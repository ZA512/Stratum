...
interface AdvancedFiltersPanelProps {
  ...
  displayToggleConfig: Array<{ key: keyof CardDisplayOptions; labelKey: string }>;
      ...
      <div className="max-h-[75vh] overflow-hidden rounded-2xl border border-white/15 bg-surface/95 shadow-2xl backdrop-blur">
        ...
        <div className="border-b border-white/10 bg-gradient-to-b from-white/[0.03] to-transparent px-6 py-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground">{tBoard('filters.panel.title')}</h3>
              <p className="mt-1 text-[11px] text-muted">{tBoard('filters.panel.subtitle')}</p>
            </div>
        ...
        <div className="max-h-[calc(75vh-80px)] overflow-y-auto px-6 py-6 scrollbar-thin">
          ...
          <div className="grid gap-6 2xl:grid-cols-2 2xl:items-start">
            ...
            <div className="space-y-6">
              ...
              <HelpTooltip
                helpMode={helpMode}
                title={tBoard('help.filters.assignees.title')}
                description={tBoard('help.filters.assignees.body')}
                hint={tBoard('help.filters.assignees.hint')}
                className="block"
              >
                <section className="rounded-xl border border-white/5 bg-white/[0.02] p-5">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground">{tBoard('filters.assignees.title')}</h4>
                  </div>
                  <MultiSelectCombo
              ...
              <HelpTooltip
                helpMode={helpMode}
                title={tBoard('help.filters.priorities.title')}
                description={tBoard('help.filters.priorities.body')}
                hint={tBoard('help.filters.priorities.hint')}
                className="block"
              >
                <section className="rounded-xl border border-white/5 bg-white/[0.02] p-5">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground">{tBoard('filters.priority.title')}</h4>
                  </div>
              ...
              <HelpTooltip
                helpMode={helpMode}
                title={tBoard('help.filters.options.title')}
                description={tBoard('help.filters.options.body')}
                hint={tBoard('help.filters.options.hint')}
                className="block"
              >
                <section className="rounded-xl border border-white/5 bg-white/[0.02] p-5">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground">{tBoard('filters.options.title')}</h4>
                  </div>
                  <div className="flex flex-wrap gap-3">
                    <label className={`flex cursor-pointer items-center gap-2 rounded-lg border px-4 py-2 text-xs transition-all ${hideDone ? 'border-accent/50 bg-accent/10 text-foreground' : 'border-white/10 bg-white/5 text-muted hover:border-accent/30'}`}>
                      ...
                      <span className="font-medium">{tBoard('filters.options.hideDone')}</span>
                    </label>
                    <label className={`flex cursor-pointer items-center gap-2 rounded-lg border px-4 py-2 text-xs transition-all ${filterHasChildren ? 'border-accent/50 bg-accent/10 text-foreground' : 'border-white/10 bg-white/5 text-muted hover:border-accent/30'}`}>
                      ...
                      <span className="font-medium">{tBoard('filters.options.withChildBoard')}</span>
                    </label>
                  </div>
                </section>
              </HelpTooltip>
            ...
            <div className="space-y-6">
              ...
              <HelpTooltip
                helpMode={helpMode}
                title={tBoard('help.filters.effort.title')}
                description={tBoard('help.filters.effort.body')}
                hint={tBoard('help.filters.effort.hint')}
                className="block"
              >
                <section className="rounded-xl border border-white/5 bg-white/[0.02] p-5">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground">{tBoard('filters.effort.title')}</h4>
                  </div>
                  <div className="flex flex-wrap gap-2">
              ...
              <HelpTooltip
                helpMode={helpMode}
                title={tBoard('help.filters.columns.title')}
                description={tBoard('help.filters.columns.body')}
                hint={tBoard('help.filters.columns.hint')}
                className="block"
              >
                <section className="rounded-xl border border-white/5 bg-white/[0.02] p-5">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground">{tBoard('filters.columns.title')}</h4>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <button
                      type="button"
              ...
              <HelpTooltip
                helpMode={helpMode}
                title={tBoard('help.filters.display.title')}
                description={tBoard('help.filters.display.body')}
                hint={tBoard('help.filters.display.hint')}
                className="block"
              >
                <section className="rounded-xl border border-white/5 bg-white/[0.02] p-5">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground">{tBoard('filters.display.title')}</h4>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {displayToggleConfig.map(({ key, labelKey }) => (
                      <button
                        key={key}
                        type="button"
